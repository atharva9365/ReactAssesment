...
const ProductDetails = () => {
  ...
  function AddtoCart() {
    const alreadyInCart = cartItems.find((item) => item.id === productDetails.id);
    if (alreadyInCart) {
      ...
      <div className="product-details">
        <div className="product-images">
          ...
          <img
            ...
            style={{ width: "90%", height: "auto", borderRadius: "1rem" }}
          />
        </div>
        <div className="product-name">
          ...
          <div className="product-rating">
            ...
            >
              <path
                d="M5.354 5.119 7.538.792A.52.52 0 0 1 
             ...
             .37-.245zM8 12.027a.5.5 0 0 
             1 .232.056l3.686 1.894-.694-3.957a.56.56 0 0 
             1 .162-.505l2.907-2.77-4.052-.576a.53.53 0 0 
          ...
          <button className="cta-cart-btnn" onClick={AddtoCart}>
            Add To Cart
          </button>
        </div>
      </div>
